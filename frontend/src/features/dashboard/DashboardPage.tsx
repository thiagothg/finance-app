  ...
  return (
    <>
      ...
      <Main className="flex flex-1 flex-col gap-4 sm:gap-6">
        <div>
          <section className="rounded-[2rem] border border-border/60 bg-[radial-gradient(circle_at_top_right,hsl(var(--primary)/0.16),transparent_33%),linear-gradient(180deg,hsl(var(--card)/0.96)_0%,hsl(var(--card))_100%)] p-6 shadow-[0_24px_70px_-45px_hsl(var(--foreground)/0.35)] backdrop-blur sm:p-8">
